        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <input type="password" name="user_pass" class="form-control" value="<?php echo $user_pass;?>" required><br>
                        <?php   
                           }
                        }
                        ?>
                        <?php
                            ...
                            if(isset($_POST['edit_submit'])){
                                ...
                                $qry_update="UPDATE users SET user_name = '{$username}', user_firstname = '{$firstname}', user_lastname = '{$lastname}', user_email = '{$email}', user_role = '{$user_role}', user_img = '{$user_img}', user_pass = '{$user_pass}' WHERE user_id = {$user_id}";
